...
So far, the repository has been created, cloned locally, and organized with an initial folder structure for application, tests and documentation.

## Planned Features

Over time, this project will grow include:

- A simple health-check application
- Local service checks using safe targets
- Docker support
- Basic logging
- Automated tests
